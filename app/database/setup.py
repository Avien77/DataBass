...
def init_db():
    ...
    try:
        ...
        tables = {
            "Student": "CREATE TABLE IF NOT EXISTS Student (Stud_ID INT PRIMARY KEY AUTO_INCREMENT, Stud_FName VARCHAR(50), Stud_LName VARCHAR(50), Stud_Phone VARCHAR(15), Year_ID INT, Stud_Gender VARCHAR(10), Stud_Email VARCHAR(100))",
            ...
            "Instrument": "CREATE TABLE IF NOT EXISTS Instrument (Instrument_ID INT PRIMARY KEY AUTO_INCREMENT, Instrument_Type INT)",
            ...
            "Guardian": "CREATE TABLE IF NOT EXISTS Guardian (Guardian_ID INT PRIMARY KEY AUTO_INCREMENT, Guardian_FName VARCHAR(50), Guardian_LName VARCHAR(50), Guardian_Phone VARCHAR(15))",
